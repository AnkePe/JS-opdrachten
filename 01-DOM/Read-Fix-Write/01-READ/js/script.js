...
// console.log(`11 toegevoegd`, $episodes);
...
console.log(`toegevoegd`, $episodes.children[3]);
...
//18
    // effe terug opgezocht hierboven
    //const $search = document.getElementById(`search`);
...
const $nav = document.querySelector(`.nav-link`);  // je selecteert de 1e
console.log(20, $nav.classList); // geef een lijst van $nav read only
$nav.classList.add(`active`);  // je voegt er ene toe
console.log(20, $nav.classList); // geef terug een lijst van $nav read only

//21
//Wat doen we hier?
//Waarom is de laatste lijn volledig grijs?
const spans = Array.from(document.getElementsByTagName(`span`));
console.log (21, `toegevoegd`, spans)
